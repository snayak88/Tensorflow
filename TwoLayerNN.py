...
W2 = tf.Variable(tf.truncated_normal([numHiddenUnits, numHiddenUnitsTwo], stddev=0.1))
B2 = tf.Variable(tf.constant(0.1), [numHiddenUnitsTwo])
W3 = tf.Variable(tf.truncated_normal([numHiddenUnitsTwo, numClasses], stddev=0.1))
